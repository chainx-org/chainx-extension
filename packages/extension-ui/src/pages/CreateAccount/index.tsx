      ...
      <div className="create-account-body">
        ...
        }
        {
          ...
          <div className="container-spacebetween margin-top-40">
            <button className="button button-white-half"
                    onClick={() => clearErrMsg() && setCurrentStep(s => s - 1)}>上一步
            </button>
            <button className="button button-yellow-half"
                    onClick={() => checkMnemonic() && setCurrentStep(s => s + 1)}>下一步
            </button>
          </div>
        }
        {
